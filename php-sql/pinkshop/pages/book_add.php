<?php
    ...
    // 从数据库中读取数据库-----读取一级分类
    $sql="SELECT id,cm_name FROM {$pre}catagoty_main WHERE id=20";
...
<div class="add-box">
    <h2>新增图书</h2>
    <form class="layui-form" action="main.php?go=book_add_do" method='post' enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
         ...
         <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="autor" required lay-verify="required" placeholder="请输入价格" autocomplete="off" class="layui-input"  style='width:300px;'>
            </div>
        </div>
         ...
         <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="public" required lay-verify="required" placeholder="请输入价格" autocomplete="off" class="layui-input"  style='width:300px;'>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style='display:flex;'>
                ...
                <div>
                    <button type="button" class="layui-btn" name='uploadPoster' id="uploadimg">
                        <i class="layui-icon">&#xe67c;</i>封面2
                    </button>

                    <input type="file" name="photo2" placeholder="请输入标题" autocomplete="off" class="layui-input" style='display:none;' id='upload2' accept="*/image"><span></span>
                </div>

                <div>
                    <button type="button" class="layui-btn" name='uploadPoster' id="uploadimg">
                        <i class="layui-icon">&#xe67c;</i>封面3
                    </button>

                    <input type="file" name="photo3" placeholder="请输入标题" autocomplete="off" class="layui-input" style='display:none;' id='upload3' accept="*/image"><span></span>
                </div>

                <div>
                    <button type="button" class="layui-btn" name='uploadPoster' id="uploadimg">
                        <i class="layui-icon">&#xe67c;</i>封面4
                    </button>

                    <input type="file" name="photo4" placeholder="请输入标题" autocomplete="off" class="layui-input" style='display:none;' id='upload4' accept="*/image"><span></span>
                </div>  

                <div>
                    <button type="button" class="layui-btn" name='uploadPoster' id="uploadimg">
                        <i class="layui-icon">&#xe67c;</i>封面5
                    </button>

                    <input type="file" name="photo5" placeholder="请输入标题" autocomplete="off" class="layui-input" style='display:none;' id='upload5' accept="*/image"><span></span>
                </div>       
        ...
        <div class="layui-form-item" style='display:flex;'>
            ...
            <div>
                ...
                <div class="layui-input-block">
                    <input type="checkbox" name="isPostFree" lay-skin="switch" value='1'>
                </div>
            </div>
        </div>
