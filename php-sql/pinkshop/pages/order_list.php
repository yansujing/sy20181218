            ...
            <thead>
             ...
             <tbody>
                ...
                <?php
                    ...
                    // 读取分类信息
                    $sql="SELECT openid,mcid,scid,o.pid,uid,order_date,cm_name,cs_name FROM {$pre}order as o LEFT JOIN {$pre}catagory_sub as s ON o.scid=s.id LEFT JOIN {$pre}catagoty_main as m ON m.id=o.mcid ORDER BY o.id";

                    $msql->execute($sql);

                    while($res=$msql->fetchquery()){

                        $res['dt']=date('Y-m-d',$res['order_date']);
