...
class Db{
    ...
    insert(cName,json){
        ...
        return new Promise((resolve,rejact)=>{
            ...
            this.connect().then(db=>{
                ...
                db.collection(cName).insert(json,(err,doc)=>{
    ...
    findSort(cName,json,tag='1'){
         ...
         return new Promise((resolve,rejact)=>{
             ...
             this.connect().then(db=>{
              ...
              db.collection(cName).find(json).sort(tag).toArray((err,doc)=>{
    ...
    // 限制数量
    findLimit(cName,json,count,page=1){
        ...
        const start=(page-1)*count;
         ...
         return new Promise((resolve,rejact)=>{
             ...
             this.connect().then(db=>{
              ...
              db.collection(cName).find(json).skip(start).limit(count).toArray((err,doc)=>{
